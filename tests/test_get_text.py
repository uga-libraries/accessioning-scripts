...
class MyTestCase(unittest.TestCase):
    ...
    #
    # def test_nonetype_multiple(self):
    #     """
    #     Test for multiple FITS elements with NoneType value.
    #     """
    #     # Reads the FITS XML (fits_row function usually does this) for test input.
    #     fits_file = os.path.join('test_FITS', 'get_text_FITS', 'element_nonetype_multiple.zip.fits.xml')
    #     ns = {"fits": "http://hul.harvard.edu/ois/xml/ns/fits/fits_output"}
    #     tree = ET.parse(fits_file)
    #     root = tree.getroot()
    #     parent = root.find("fits:identification/fits:identity", ns)
    ...
    #
    #     # Compares the results. assertEqual prints "OK" or the differences between the two strings.
    #     self.assertEqual(result, expected, 'Problem with nonetype multiple')

    def test_nonetype_mix(self):
        """
        Test for mix of FITS elements with NoneType and actual values.
        """
        # Reads the FITS XML (fits_row function usually does this) for test input.
        fits_file = os.path.join('test_FITS', 'get_text_FITS', 'element_nonetype_mix.zip.fits.xml')
        ns = {"fits": "http://hul.harvard.edu/ois/xml/ns/fits/fits_output"}
        tree = ET.parse(fits_file)
        root = tree.getroot()
        ...
        # Compares the results. assertEqual prints "OK" or the differences between the two strings.
        self.assertEqual(result, expected, 'Problem with nonetype mix')
