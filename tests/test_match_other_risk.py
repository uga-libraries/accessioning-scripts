...
which already has information from FITS, NARA and technical appraisal,
...
class MyTestCase(unittest.TestCase):
    ...
    def test_no_risk_low_only(self):
        ...
        # Compares the results. assertEqual prints "OK" or the differences between the two lists.
        self.assertEqual(results, expected, 'Problem with no risk, NARA low risk but not transform')
    ...
    def test_no_risk_transform_only(self):
        ...
        # Compares the results. assertEqual prints "OK" or the differences between the two lists.
        self.assertEqual(results, expected, 'Problem with no risk, NARA transform but not low risk')
    ...
    def test_nara(self):
        ...
        # Compares the results. assertEqual prints "OK" or the differences between the two lists.
        self.assertEqual(results, expected, 'Problem with NARA low risk/transform')
    ...
    #     """
    #     Test for files that match a format for other risk, where the case matches
    ...
    def test_format_case_no_match(self):
        """
        Test for files that match a format for other risk, where case does not matching case
        and the entire format name is matched.
        The format is not NARA low risk with a plan to transform.
        Result for testing is the df returned by the function, converted to a list for an easier comparison.
        """
        # Creates test input and runs the code to be tested.
    ...
    #     """
    #     Test for files that match a format for other risk, where case does not match
    #     and only partially matching the format string.
    #     The format is not NARA low risk with a plan to transform.
    #     Result for testing is the df returned by the function, converted to a list for an easier comparison.
    #     """
    ...
    def test_nara_and_format(self):
        ...
        # Compares the results. assertEqual prints "OK" or the differences between the two lists.
        self.assertEqual(results, expected, 'Problem with NARA and format')
