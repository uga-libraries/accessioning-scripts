...
class MyTestCase(unittest.TestCase):
    ...
    def test_no_risk(self):
        ...
        df_results = pd.DataFrame(rows, columns=['FITS_Format_Name', 'NARA_Risk_Level', 'NARA_Proposed_Preservation_Plan'])
        ...
        expected = [['FITS_Format_Name', 'NARA_Risk_Level', 'NARA_Proposed_Preservation_Plan', 'Other_Risk'],
    ...
    def test_no_risk_format_partial(self):
        ...
        df_results = pd.DataFrame(rows,
                                  columns=['FITS_Format_Name', 'NARA_Risk_Level', 'NARA_Proposed_Preservation_Plan'])
        df_other = csv_to_dataframe(c.RISK)
