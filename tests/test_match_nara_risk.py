...
class MyTestCase(unittest.TestCase):
    ...
    def test_puid_single(self):
        ...
        """
        # Creates test input and runs the code to be tested.
        ...
        self.assertEqual(results, expected, 'Problem with PUID, single match')
    ...
    def test_puid_multiple(self):
        ...
        rows = [['C:\\PUID\\file.html', 'HTML', '1.0', 'https://www.nationalarchives.gov.uk/pronom/fmt/102'],
                ['C:\\PUID\\file.wpd', 'WordPerfect 5.1 for DOS', np.NaN, 'https://www.nationalarchives.gov.uk/pronom/x-fmt/394']]
        df_fits = pd.DataFrame(rows, columns=['FITS_File_Path', 'FITS_Format_Name', 'FITS_Format_Version', 'FITS_PUID'])
        df_nara = csv_to_dataframe(c.NARA)
        df_results = match_nara_risk(df_fits, df_nara)
        ...
        expected = [['C:\\PUID\\file.html', 'HTML', '1.0', 'https://www.nationalarchives.gov.uk/pronom/fmt/102',
                    ...
                    ['C:\\PUID\\file.wpd', 'WordPerfect 5.1 for DOS', np.NaN, 'https://www.nationalarchives.gov.uk/pronom/x-fmt/394',
                     ...
                     'Moderate Risk', 'Transform to PDF', 'PRONOM'],
                    ['C:\\PUID\\file.wpd', 'WordPerfect 5.1 for DOS', np.NaN, 'https://www.nationalarchives.gov.uk/pronom/x-fmt/394',
                    'WordPerfect 5.1 for Windows', 'wpd|wp5', 'https://www.nationalarchives.gov.uk/pronom/x-fmt/394',
                    'Moderate Risk', 'Transform to PDF', 'PRONOM']]

        # Compares the results. assertEqual prints "OK" or the differences between the two lists.
        self.assertEqual(results, expected, 'Problem with PUID, multiple matches')
    ...
    def test_name_version_case(self):
        ...
        # Compares the results. assertEqual prints "OK" or the differences between the two lists.
        self.assertEqual(results, expected, 'Problem with name and version, case match')
    ...
    def test_name_version_not_case(self):
        ...
        # Compares the results. assertEqual prints "OK" or the differences between the two lists.
        self.assertEqual(results, expected, 'Problem with name and version, case does not match')
    ...
    def test_name_case(self):
        ...
        # Compares the results. assertEqual prints "OK" or the differences between the two lists.
        self.assertEqual(results, expected, 'Problem with name, case match')
    ...
    def test_name_not_case(self):
        ...
        # Compares the results. assertEqual prints "OK" or the differences between the two lists.
        self.assertEqual(results, expected, 'Problem with name, case does not match')
    ...
    def test_name_multiple(self):
        ...
        # Compares the results. assertEqual prints "OK" or the differences between the two lists.
        self.assertEqual(results, expected, 'Problem with name, multiple matches')
    ...
    def test_extension_case(self):
        ...
        # Compares the results. assertEqual prints "OK" or the differences between the two lists.
        self.assertEqual(results, expected, 'Problem with extension, case match')
    ...
    def test_extension_no_case(self):
        ...
        # Compares the results. assertEqual prints "OK" or the differences between the two lists.
        self.assertEqual(results, expected, 'Problem with extension, case does not match')
    ...
    def test_extension_pipe_case(self):
        ...
        expected = [['C:\\Ext\\file.gz', 'g-zip', '', '', 'GZIP', 'gz|tgz',
                    ...
                    ['C:\\Ext\\file.fods', 'OpenDocument Spreadsheet', '', '', 'OpenDocument Spreadsheet 1.0',
                     'ods|fods', 'https://www.nationalarchives.gov.uk/pronom/fmt/137', 'Low Risk', 'Retain', "File Extension"]]

        # Compares the results. assertEqual prints "OK" or the differences between the two lists.
        self.assertEqual(results, expected, 'Problem with extension (piped), case match')
    ...
    def test_extension_pipe_no_case(self):
        ...
        # Compares the results. assertEqual prints "OK" or the differences between the two lists.
        self.assertEqual(results, expected, 'Problem with extension (piped), case does not match')
    ...
    def test_extension_multiple(self):
        ...
        # Compares the results. assertEqual prints "OK" or the differences between the two lists.
        self.assertEqual(results, expected, 'Problem with extension, multiple matches')
    ...
    def test_no_match(self):
        ...
        # Makes lists of the actual results from the test and the expected results.
        results = df_results.values.tolist()
        expected = [['C:\\None\\file.abc', 'New Format', '', '', np.NaN, np.NaN, np.NaN, 'No Match', np.NaN, 'No NARA Match'],
                    ['C:\\None\\file', 'Unknown Binary', '', '', np.NaN, np.NaN, np.NaN, 'No Match', np.NaN, 'No NARA Match']]

        # Compares the results. assertEqual prints "OK" or the differences between the two lists.
        self.assertEqual(results, expected, 'Problem with no matches')
