...
class MyTestCase(unittest.TestCase):
    ...
    def test_fits_no_version(self):
        """
        Testing narrowing the match for FITS with no version number to just NARA unspecified version if present.
        """
        # Creates test input.
        df_fits = csv_to_dataframe(os.path.join('test_combined_fits', 'unspecified_fits.csv'))
        ...
        expected = [['FITS_File_Path', 'FITS_Format_Name', 'FITS_Format_Version', 'FITS_PUID', 'NARA_Format Name',
                    ...
                    ['C:\\unspecified\\file.css', 'Cascading Style Sheets', np.NaN,
                     'https://www.nationalarchives.gov.uk/pronom/x-fmt/224', 'Cascading Style Sheets 1.0', 'css',
                    ...
                    ['C:\\unspecified\\file.css', 'Cascading Style Sheets', np.NaN,
                     ...
                     'https://www.nationalarchives.gov.uk/pronom/x-fmt/224', 'Low Risk', 'Retain', 'PRONOM'],
                    ['C:\\unspecified\\file.css', 'Cascading Style Sheets', np.NaN,
                     'https://www.nationalarchives.gov.uk/pronom/x-fmt/224', 'Cascading Style Sheets 2.1', 'css',
                     'https://www.nationalarchives.gov.uk/pronom/x-fmt/224', 'Low Risk', 'Retain', 'PRONOM'],
                    ['C:\\unspecified\\file.css', 'Cascading Style Sheets', np.NaN,
                     'https://www.nationalarchives.gov.uk/pronom/x-fmt/224',
                     'Cascading Style Sheets unspecified version', 'css',
                     'https://www.nationalarchives.gov.uk/pronom/x-fmt/224', 'Low Risk', 'Retain', 'PRONOM'],
                    ['C:\\unspecified\\file.pict', 'Macintosh PICT', np.NaN,
                     'https://www.nationalarchives.gov.uk/pronom/x-fmt/80', "Macintosh PICT unspecified version",
                     'pict|pct|pic', 'https://www.nationalarchives.gov.uk/pronom/x-fmt/80', 'Moderate Risk',
                     'Transform to PNG or JPEG', 'PRONOM'],
                    ['C:\\unspecified\\file.vsd', 'Microsoft Visio Drawing', np.NaN,
                     'https://www.nationalarchives.gov.uk/pronom/fmt/442',
                     'Microsoft Visio Drawing unspecified version', 'vsd',
                     'https://www.nationalarchives.gov.uk/pronom/fmt/442', 'Moderate Risk', 'Transform to PDF',
                     'PRONOM'],
                    ...
                    ['C:\\unspecified\\file.gif', 'Graphics Interchange Format', np.NaN, np.NaN,
                     ...
                     'File Extension'],
                    ['C:\\unspecified\\file.pcx', 'PiCture eXchange (PCX)', np.NaN, np.NaN,
                     'PiCture eXchange (PCX) version 0', 'pcx|pcc', 'https://www.nationalarchives.gov.uk/pronom/fmt/86',
                     'Moderate Risk', 'Transform to PNG or JPEG', 'File Extension'],
                    ['C:\\unspecified\\file.pcx', 'PiCture eXchange (PCX)', np.NaN, np.NaN,
                     'PiCture eXchange (PCX) version 2', 'pcx|pcc',
                     'https://www.nationalarchives.gov.uk/pronom/fmt/87', 'Moderate Risk',
                     'Transform to PNG or JPEG', 'File Extension'],
                    ['C:\\unspecified\\file.pcx', 'PiCture eXchange (PCX)', np.NaN, np.NaN,
                     'PiCture eXchange (PCX) version 3',
                     'pcx|pcc', 'https://www.nationalarchives.gov.uk/pronom/fmt/88', 'Moderate Risk',
                     'Transform to PNG or JPEG', 'File Extension'],
                    ['C:\\unspecified\\file.pcx', 'PiCture eXchange (PCX)', np.NaN, np.NaN,
                     'PiCture eXchange (PCX) version 4',
                     'pcx|pcc', 'https://www.nationalarchives.gov.uk/pronom/fmt/89', 'Moderate Risk',
                     'Transform to PNG or JPEG', 'File Extension'],
                    ['C:\\unspecified\\file.pcx', 'PiCture eXchange (PCX)', np.NaN, np.NaN,
                     'PiCture eXchange (PCX) version 5',
                     'pcx|pcc', 'https://www.nationalarchives.gov.uk/pronom/fmt/90', 'Moderate Risk',
                     'Transform to PNG or JPEG', 'File Extension']]

        # Compares the results. assertEqual prints "OK" or the differences between the two lists.
        self.assertEqual(result, expected, 'Problem with FITS no version')
