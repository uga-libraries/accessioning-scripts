...
class MyTestCase(unittest.TestCase):
    ...
    def test_nara_risk_subset(self):
        ...
        expected = [['C:\\CD1\\file.bak', 'Backup File', np.NaN, False, '5/5/2022', 1.23, 'ab1e0b017c8eex694eb379e354571234', 'High Risk', 'Retain', 'Format Name', 'Not for TA', 'Not for Other'],
                    ['C:\\CD1\\file.psd', 'Adobe Photoshop file', np.NaN, False, '5/5/2022', 57.01, 'le1b6b058c8rrb684ex370e354572936', 'Moderate Risk', 'Transform to TIFF or JPEG2000', 'PRONOM', 'Not for TA', 'Layered image file'],
    ...
    def test_multiple_ids_subset(self):
        ...
        expected = [['C:\\CD2\\overview-summary.html', 'HTML Transitional', 'HTML 4.01', np.NaN, 'Jhove version 1.20.1', True, '5/5/2022', 7.496, '1fcd29526b78728d69e0b0487223fe43', np.NaN, 'Low Risk', 'Retain', 'File Extension', 'Not for TA', 'Not for Other'],
                    ['C:\\CD2\\overview-summary.html', 'HTML Transitional', 'HTML 4.01', np.NaN, 'Jhove version 1.20.1', True, '5/5/2022', 7.496, '1fcd29526b78728d69e0b0487223fe43', np.NaN, 'Low Risk', 'Retain', 'File Extension', 'Not for TA', 'Not for Other'],
                    ['C:\\CD2\\overview-summary.html', 'Hypertext Markup Language', '4.01', 'https://www.nationalarchives.gov.uk/pronom/fmt/1', 'Droid version 6.4; file utility version 5.03', True, '5/5/2022', 7.496, '1fcd29526b78728d69e0b0487223fe43', np.NaN, 'Low Risk', 'Retain', 'PRONOM', 'Not for TA', 'Not for Other'],
                    ['C:\\CD2\\overview-tree.html', 'HTML Transitional', 'HTML 4.01', np.NaN, 'Jhove version 1.20.1', True, '5/5/2022', 28.38, 'fd50cd9e7ab6551cd726b49021f0c439', np.NaN, 'Low Risk', 'Retain', 'File Extension', 'Not for TA', 'Not for Other'],
                    ['C:\\CD2\\overview-tree.html', 'HTML Transitional', 'HTML 4.01', np.NaN, 'Jhove version 1.20.1', True, '5/5/2022', 28.38, 'fd50cd9e7ab6551cd726b49021f0c439', np.NaN, 'Low Risk', 'Retain', 'File Extension', 'Not for TA', 'Not for Other'],
                    ['C:\\CD2\\overview-tree.html', 'Hypertext Markup Language', '4.01', 'https://www.nationalarchives.gov.uk/pronom/fmt/1', 'Droid version 6.4; file utility version 5.03', True, '5/5/2022', 28.38, 'fd50cd9e7ab6551cd726b49021f0c439', np.NaN, 'Low Risk', 'Retain', 'PRONOM', 'Not for TA', 'Not for Other'],
                    ['C:\\FD1\\Worksheet Excel Version.xlsx', 'Office Open XML Document', '27 onwards', 'https://www.nationalarchives.gov.uk/pronom/fmt/189', 'Droid version 6.4', True, '5/5/2022', 15.766, 'e0aeaee6f3046bf5568c8076522d83a5', 'Low Risk', 'Retain', 'File Extension', 'Not for TA', 'Not for Other'],
                    ['C:\\FD1\\Worksheet Excel Version.xlsx', 'Office Open XML Workbook', np.NaN, np.NaN, 'Tika version 1.21', True, '5/5/2022', 15.766, 'e0aeaee6f3046bf5568c8076522d83a5', 'Microsoft Excel', 'Low Risk', 'Retain', 'File Extension', 'Not for TA', 'Not for Other'],
                    ['C:\\FD1\\Worksheet Excel Version.xlsx', 'XLSX', np.NaN, np.NaN, 'Exiftool version 11.54', True, '5/5/2022', 15.766, 'e0aeaee6f3046bf5568c8076522d83a5', 'Microsoft Excel', 'Low Risk', 'Retain', 'File Extension', 'Not for TA', 'Not for Other']]
    ...
    def test_validation_subset(self):
        ...
        expected = [['C:\\CD1\\file.bak', 'Backup File', np.NaN, np.NaN, 'file utility version 5.03', False, '5/5/2022', 1.23, 'ab1e0b017c8eex694eb379e354571234', np.NaN, False, True, np.NaN, 'High Risk', 'Retain', 'Format Name', 'Not for TA', 'Not for Other'],
                    ['C:\\CD1\\file.psd', 'Adobe Photoshop file', np.NaN, 'https://www.nationalarchives.gov.uk/pronom/x-fmt/92', 'file utility version 5.03', False, '5/5/2022', 57.01, 'le1b6b058c8rrb684ex370e354572936', np.NaN, True, False, np.NaN, 'Moderate Risk', 'Transform to TIFF or JPEG2000', 'PRONOM', 'Not for TA', 'Layered image file'],
    ...
    def test_other_risk_subset(self):
        ...
        expected = [['C:\\CD1\\file.psd', 'Adobe Photoshop file', np.NaN, 'file utility version 5.03', False, 57.01, 'Moderate Risk', 'Transform to TIFF or JPEG2000', 'PRONOM', 'Not for TA', 'Layered image file'],
