...
class MyTestCase(unittest.TestCase):
    ...
    def test_format_subtotal(self):
        ...
        self.assertEqual(result, expected, 'Problem with format subtotal')
    ...
    def test_nara_risk_subtotal(self):
        ...
        # Compares the results. assertEqual prints "OK" or the differences between the two lists.
        self.assertEqual(result, expected, 'Problem with NARA risk subtotal')
    ...
    def test_tech_appraisal_subtotal(self):
        ...
        # Compares the results. assertEqual prints "OK" or the differences between the two lists.
        self.assertEqual(result, expected, 'Problem with technical appraisal subtotal')
    ...
    def test_other_risk_subtotal(self):
        ...
        # Compares the results. assertEqual prints "OK" or the differences between the two lists.
        self.assertEqual(result, expected, 'Problem with other risk subtotal')
