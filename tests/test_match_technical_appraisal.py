...
which already has information from FITS and NARA, based on the folder names and ITAfileformats.csv.
...
class MyTestCase(unittest.TestCase):
    ...
    def test_not_ta(self):
        ...
        self.assertEqual(results, expected, 'Problem with not technical appraisal')

    def test_not_ta_or_trash(self):
        """
        Test for files that do not meet any technical appraisal criteria.
        There is a folder that contains the string "Trash" but it is not the entire folder name, so it isn't matched.
        Result for testing is the df returned by the function, converted to a list for an easier comparison.
        """
        # Creates test input and runs the code to be tested.
        ...
        # Compares the results. assertEqual prints "OK" or the differences between the two lists.
        self.assertEqual(results, expected, 'Problem with not technical appraisal, including trash in a folder name')
    ...
    def test_format_case_match(self):
        ...
        They are not in a trash folder.
        Result for testing is the df returned by the function, converted to a list for an easier comparison.
        """
        # Creates test input and runs the code to be tested.
        ...
        # Compares the results. assertEqual prints "OK" or the differences between the two lists.
        self.assertEqual(results, expected, 'Problem with format, case matches')
    ...
    def test_format_case_match_partial(self):
        ...
        # Compares the results. assertEqual prints "OK" or the differences between the two lists.
        self.assertEqual(results, expected, 'Problem with format, case matches, partial string')
    ...
    def test_format_case_no_match(self):
        ...
        # Compares the results. assertEqual prints "OK" or the differences between the two lists.
        self.assertEqual(results, expected, 'Problem with format, case does not match')
    ...
    def test_format_case_no_match_partial(self):
        ...
        # Compares the results. assertEqual prints "OK" or the differences between the two lists.
        self.assertEqual(results, expected, 'Problem with format, case does not match, partial string')

    def test_trash(self):
        """
        Test for files that are in a folder named "trash".
        The format is not in the ITAfileformats.csv spreadsheet.
        Result for testing is the df returned by the function, converted to a list for an easier comparison.
        """
        # Creates test input and runs the code to be tested.
        ...
        # Compares the results. assertEqual prints "OK" or the differences between the two lists.
        self.assertEqual(results, expected, 'Problem with trash folder')
    ...
    def test_trashes(self):
        ...
        # Compares the results. assertEqual prints "OK" or the differences between the two lists.
        self.assertEqual(results, expected, 'Problem with trashes folder')
    ...
    def test_format_and_trash(self):
        ...
        # Compares the results. assertEqual prints "OK" or the differences between the two lists.
        self.assertEqual(results, expected, 'Problem with format and trash')
